...
import com.gxzd.gxzd.constant.UserLoginStatus;
...
public class JwtUtils {
    ...
    public static String getJwtToken(Integer id,String name){
        ...
        String JwtToken = Jwts.builder()
                ...
                .setSubject("xyoto-user")
                //.setIssuedAt(new Date())
                //过期时间不再由jwt维护，由redis统一维护
    ...
    public static Integer getMemberIdByJwtToken(HttpServletRequest request) {
        String jwtToken = request.getHeader("token");
        if(StringUtils.isEmpty(jwtToken)) {
            return UserLoginStatus.UN_LOGIN;
        }
    ...
    public static Integer getMemberIdByJwtToken(String token){
